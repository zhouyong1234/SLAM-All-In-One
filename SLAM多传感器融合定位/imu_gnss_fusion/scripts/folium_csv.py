...
f1 = open("/home/touchair/orb_ws/src/imu_gps_localization/gps.csv")
f2 = open("/home/touchair/orb_ws/src/imu_gps_localization/state.csv")
...
my_map = folium.Map(
    location=[points2[0][0],points2[-1][1]], 
    zoom_start=15, 
    tiles='OpenStreetMap',
    png_enabled=True, 
    prefer_canvas=True)

folium.PolyLine(points1, color="red", weight=4.0, opacity=1).add_to(my_map)

# folium.PolyLine(points2, color="blue", weight=8.0, opacity=1).add_to(my_map)
