...
class IMU {
 public:
  ...
  void propagate_state(
    ...
    // std::cout << "vec_na: " << vec_na.transpose() << std::endl;
    // std::cout << "vec_ng: " << vec_ng.transpose() << std::endl;
    // std::cout << "vec_wa: " << vec_wa.transpose() << std::endl;
    // std::cout << "vec_wg: " << vec_wg.transpose() << std::endl;
