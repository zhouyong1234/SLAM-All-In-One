...
public:
    ...
    bool ProcessImuData(const ImuDataPtr imu_data_ptr, State* fused_state, double gps_timestamp);

    bool ProcessGpsPositionData(const GpsPositionDataPtr gps_data_ptr, State* fused_state);
