...
//静态成员变量必须在类外初始化
double global_localization::GNSSData::origin_longitude = 0.0;
double global_localization::GNSSData::origin_latitude = 0.0;
double global_localization::GNSSData::origin_altitude = 0.0;
bool global_localization::GNSSData::origin_position_inited = false;
GeographicLib::LocalCartesian global_localization::GNSSData::geo_converter;
