...
#ifndef GLOBAL_LOCALIZATION_MODELS_SCAN_CONTEXT_MANAGER_HPP_
#define GLOBAL_LOCALIZATION_MODELS_SCAN_CONTEXT_MANAGER_HPP_
...
#include "global_localization/scan_context_manager/kdtree_vector_of_vectors_adaptor.hpp"
