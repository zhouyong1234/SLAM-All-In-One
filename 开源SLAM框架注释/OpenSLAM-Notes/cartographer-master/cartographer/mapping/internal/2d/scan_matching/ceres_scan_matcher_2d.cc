...
// 使用ceres构造优化问题，将激光和地图信息进行匹配
// 核心在于调用函数 CreateOccupiedSpaceCostFunction2D TranslationDeltaCostFunctor2D RotationDeltaCostFunctor2D 
// 构造优化问题
// target_translation    运动滤波器的平移分量
// initial_pose_estimate 搜索得到的初始值
// point_cloud           点云
// grid                  栅格地图
// pose_estimate         优化得到的位姿
                               ...
                               ceres::Solver::Summary* const summary) const 
{
  ...
  switch (grid.GetGridType()) {
    case GridType::PROBABILITY_GRID:// 栅格地图
      // 添加误差项
