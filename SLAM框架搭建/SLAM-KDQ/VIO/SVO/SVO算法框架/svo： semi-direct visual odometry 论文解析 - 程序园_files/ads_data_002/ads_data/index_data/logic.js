...
function startAnimation(){
	...
	TweenLite.set(["#delearName"],{x:970,alpha:1});	
	TweenLite.set(["#acura-logo",".ad"], { alpha:1});
	TweenLite.set(["#f2white_bg"],{x:970, alpha:1});
	TweenLite.set(["#frame2-bg_1"],{x:970, alpha:1});
...
function frame2Animation(){
	TweenLite.set(["#frame2-bg", "#cta", "#acura-logo-2","#f2_ilx_logo","#frame3_copy1",],{x:970, alpha:1});
	TweenLite.to(["#acura-logo", "#frame1_copy1", "#frame1_copy2","#frame1_copy3",], 0.3, {alpha:0, delay:0.6});

	TweenLite.to(["#frame2-bg","#frame2-bg_1", "#cta", "#acura-logo-2","#f2_ilx_logo","#frame3_copy1","#frame2-bg_1"], 0.5, {x:0, ease: Quad.easeIn, delay:0});
	TweenLite.to("#frame2-bg", 3, {scale:1.1, ease: Quad.easeIn, delay:0.3});
	TweenLite.to(["#frame3_copy1"], 0.4, {x:-380, ease: Quad.easeIn, delay:3.3});
	
	TweenLite.delayedCall(3.5,frame3Animation);
}
function frame3Animation(){
	TweenLite.set(["#frame3_copy2"],{x:970, alpha:0});
...
function frame4Animation(){
	...
	TweenLite.set(["#frame4-bg"],{x:970, alpha:0});
	TweenLite.set(["#frame4_copy1","#frame4_copy2","#delearName"],{x:970, alpha:0});

	TweenLite.to(["#frame3_copy1","#frame3_copy2","#frame2-bg","#frame3_copy1","#frame2-bg_1"], 0.4, {x:-970, ease: Quad.easeOut,delay:0});
