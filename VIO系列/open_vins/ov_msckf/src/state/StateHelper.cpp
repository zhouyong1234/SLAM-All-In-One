...
void StateHelper::EKFUpdate(std::shared_ptr<State> state, const Eigen::MatrixXd &H, const Eigen::VectorXd &res, const Eigen::MatrixXd &R)
{
  ...
  // std::cout << P_minus.size() << std::endl;

  // std::cout << delta_x.size() << std::endl;
