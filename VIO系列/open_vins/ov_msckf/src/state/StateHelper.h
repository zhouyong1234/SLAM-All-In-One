...
public:
  ...
  static void EKFUpdate(std::shared_ptr<State> state, const Eigen::MatrixXd &H, const Eigen::VectorXd &res, const Eigen::MatrixXd &R);

  static void LimitMinDiagValue(const double min_diag_val, Eigen::MatrixXd* mat)
  {
