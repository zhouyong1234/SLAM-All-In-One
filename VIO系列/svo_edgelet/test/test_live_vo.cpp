...
void BenchmarkNode::InitSystem(int w, int h, double fov)
{
    ...
    cam_ = new svo::PinholeCamera(640, 480, 484.0910811928012, 484.01576020265475, 321.6130540995404, 238.71540961023783);
...
void BenchmarkNode::runFromFolder()
{
    ...
    cv::VideoCapture cap("/home/touchair/test/hall_640x480.mp4");  // open the default camera
    ...
    for (;;) {
        ...
        if(vo_->lastFrame() != NULL)
        {
            ...
            std::cout << "Frame pose: " << std::endl << vo_->lastFrame()->T_f_w_.matrix() << std::endl;
