...
bool ImageProcessor::loadParameters() {
  ...
  cam0_distortion_model = Config::get<string>("Camera.distortion.model");

  cam0_resolution[0] = Config::get<int>("Camera.resolution.x");
  cam0_resolution[1] = Config::get<int>("Camera.resolution.y");

  cam0_intrinsics[0] = Config::get<double>("Camera.fx");
  cam0_intrinsics[1] = Config::get<double>("Camera.fy");
  cam0_intrinsics[2] = Config::get<double>("Camera.cx");
  cam0_intrinsics[3] = Config::get<double>("Camera.cy");

  cam0_distortion_coeffs[0] = Config::get<double>("Camera.k1");
  cam0_distortion_coeffs[1] = Config::get<double>("Camera.k2");
